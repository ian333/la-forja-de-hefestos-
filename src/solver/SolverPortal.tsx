...
import PasosView from './components/PasosView';
...
// El render de pasos (tex/Math/PasoCard/ResultadoVista) ahora vive en
// ./components/PasosView.tsx para compartirse con el Math Lab. `Math` se importa
// de ahi (se sigue usando aqui para la respuesta destacada inline).
