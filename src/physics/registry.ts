...
export const BRANCHES: PhysicsBranch[] = [
  ...
  },
  {
    ...
    modules: [
      ...
      { id: 'boost-v2', name: 'Impresora de metal v2 — río, bombas, presa, válvula, gota', status: 'live',
        blurb: 'La máquina completa con el BOM real: 3 boost interleaved (bombas) + banco 120V (presa) + choke con banda 40-60A (válvula) + ciclo de gota contra el muro de Holm.',
        childHint: 'Tres bombas llenan la presa a cucharadas turnándose; la válvula sirve el chorro justo para fundir el alambre y soltar gotas de metal. ¡Mira la corriente bailar entre las dos líneas!',
        researcherHint: 'boostV2.ts (gemelo de v2-sim-final.py): boost DCM con rampa RL real (IRF640N Rds+shunt 0.1Ω+Rac bobina, MUR1560 Vf) η~91%; choke 50µH limita falla 80→2.4A/µs, banda histéresis 40-60A ~30kHz; ciclo contacto(Holm 15.6Ω, 923W)→funde(Rj→1.2Ω)→pincha(1.5ms)→arco; muro: funde⟺V²/R>34W (424Ω@120V vs 76Ω@51V del v1).',
        component: BoostV2 },
    ],
  },
];
