...
export const PREMIO_LABS: Record<string, LazyExoticComponent<ComponentType<unknown>>> = {
  ...
  'romer-capsula-1': lazy(() => import('@/masterclass/cine/scenes/RomerCapsula1')),
  'imprenta-capsula': lazy(() => import('@/masterclass/cine/scenes/ImprentaCapsula')),
  'brujula-capsula': lazy(() => import('@/masterclass/cine/scenes/BrujulaCapsula')),
  'transistor-capsula': lazy(() => import('@/masterclass/cine/scenes/TransistorCapsula')),
  'transistor-real': lazy(() => import('@/masterclass/cine/scenes/TransistorRealCapsula')),
  'silicio-nube': lazy(() => import('@/masterclass/cine/scenes/SilicioNubeCapsula')),
  'materia-nube': lazy(() => import('@/masterclass/cine/scenes/MateriaNubeCapsula')),
